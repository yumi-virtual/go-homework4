...
var (
	...
	ErrInvalidParameter      = &Error{HTTPCode: 400, Code: 10006, Msg: "Invalid request parameter"}
	ErrStatusForbidden       = &Error{HTTPCode: 400, Code: 10007, Msg: "You are not the author of the post"}
	ErrBadPassword           = &Error{HTTPCode: 400, Code: 10008, Msg: "Failed to hash password"}
	ErrInvalidNameOrPassword = &Error{HTTPCode: 400, Code: 10009, Msg: "Invalid username or password"}
	ErrLogin                 = &Error{HTTPCode: 400, Code: 10010, Msg: "Failed to login"}
)
